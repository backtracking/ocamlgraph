...
module type S = sig
  ...
  val mirror : g -> g
  (** [mirror g] returns a new graph which is the mirror image (also
      called converse, transpose, or reverse) of [g]: each edge from
      [u] to [v] has been replaced by an edge from [v] to [u].
