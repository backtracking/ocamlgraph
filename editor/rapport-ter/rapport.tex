...
de données des graphes, et aussi pour fonctionnalités internes à
...
portage en \ocaml\ s'appelle Lablgtk \cite{lablgtk}, qui permet des
interactions bien plus intéressantes avec l'utilisateur.
Et enfin, viennent les fonctionnalités d'éditions .

Durant ce stage, plusieurs points plus ou moins nouveaux et plus ou
moins difficiles on dû être abordé :
\begin{itemize}
\item la découverte et l'utilisation d'un serveur \texttt {subversion}
\item la découverte des modules et de la couche objet de
  \ocaml~\cite{ocaml}
\item l'utilisation intensive de Linux
\item la découverte de Emacs\cite{emacs} et de quelques modes
