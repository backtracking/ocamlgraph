...
la géométrie euclidienne sont conservés tels que : une droite est le chemin le plus
court reliant deux points; deux droites sont parallèles si elles ne
s'intersectent pas. Cette géométrie dite hyperbolique est donc
...
l'observateur. Ainsi le bord du disque est in-atteignable pour ce petit
...
problème est bien-sûr de placer correctement les noeuds et ensuite le
traçage des arêtes est relativement trivial avec l'aide de notre
tortue et de ses fonctions de mouvement.

Pour répartir les n\oe uds d'un arbre dans le plan hyperbolique, il se
...
s'intéresser au placement des noeuds d'un graphe qui pose certains
