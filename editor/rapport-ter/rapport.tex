...
prenant la figure \ref{fig:parallels}, relativement simple, basé sur
...
\begin{figure}
  \centering
   \includegraphics[scale=0.35]{perpendiculaire.eps}  
...
\begin{figure}
  \centering
  \includegraphics[scale=0.30]{htree.eps}
...
\begin{figure}
\begin{center}
 \includegraphics[scale=0.30]{db4_dfs.eps}  \quad
 \includegraphics[scale=0.30]{db4_bfs.eps}  
\end{center}
  \caption{Intér\^et d'un parcours en profondeur}
  \label{fig:dfs}
\end{figure}

\begin{figure}
\begin{center}
 \includegraphics[scale=0.30]{parcours_dfs.eps}  \quad
 \includegraphics[scale=0.30]{parcours_bfs.eps}  
\end{center}
