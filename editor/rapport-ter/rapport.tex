...
Ce modèle est doté d'une métrique, qui est une fonction permettant de
...
tout comme son équivalente en géométrie euclidienne. Bien entendu,
pour représenter ce déplacement, il nous faut des fonctions pour
connaître la position et la direction après un pas de mouvement.
Ces foncions sont détaillés dans \miquel.
