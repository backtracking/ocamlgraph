...
$$
\delta(A,B) = \mathrm{ath}\left(\left|\frac{A-B}{1-AB}\right|\right)
\quad\mbox{où}~
...
compréhensionde la géométrie hyperbolique. Il faut clairement
comprendre que nous aurons deux mondes :
- le point de vue de l'observateur qui voit un disque unité, par
définition un espace borné, sur le lequel se déplace la tortue
- le point de vue de la tortue qui se déplace dans le plan 
hyperbolique, par définition un espace infini

Une tortue est définie par un type turtle composé d'une position et
d'une direction. Elle peut avancer et tourner, à gauche  et à droite
tout comme son équivalente en géométrie euclidienne.
