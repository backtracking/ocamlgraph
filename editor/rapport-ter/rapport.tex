...
pencher sur la \figl{lentille} ci-après qui représente le plan euclidien sur
...
\begin{figure}
  ...
  \caption{Représentation de passage entre le plan euclidien et le plan hyperbolique}
  \label{fig:lentille}
\end{figure}

 On peut voir \figs{cercles} que pour représenter un
...
perpendiculaires à $C$ comme illustré par la droite $D_3$ ci-après \figs{cercles}.  
\begin{figure}[!b]
  \centering
