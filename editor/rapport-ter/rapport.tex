...
% deux différences
% - les successeurs peuvent avoir été déjà dessinés -> pas considérés
% - arêtes supplémentaires << transversales >>


\subsection{Heuristiques de placement}

% dfs / bfs déséquilibre

% ordonnancement des successeurs -> moins d'arêtes qui se croisent
