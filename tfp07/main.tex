...
this problem using \ocamlgraph\footnote{Full source code for the
  Sudoku example is available on the web page of \ocamlgraph.}. There are
...
\ocamlgraph algorithm (resp. data structure).
This genericity is obtained using \ocaml module
system and especially its functors which allow sharing large pieces
of code.
...
libraries are rarely as generic and never provide as many
