...
The code in Figure~\ref{fig:sudoku} is the sketch of the solution to
...
\item We choose a graph data structure for our Sudoku solver: it is an
  ...
  integers and unlabeled edges. In this structure, vertices are also
...
(* vertices with initial constraints and edges are 
   added to [g] using [G.add\_vertex] and [G.add\_edge]. 
   It amounts to 20 lines of code. *)
