...
~\\
\psfig{file=/home/jsignole/dev/ocamlgraph/slides/lsl/interface.eps,width=\textwidth}
...
\begin{points}
\item \bleu{Quelques limitations} du système de modules nous ont gênés
  \begin{itemize}
