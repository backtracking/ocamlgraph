...
\begin{frame}
  ...
  \end{center}
  \includegraphics[width=0.15\textwidth]{cealist.pdf}\\[-0.5em]
  \hfill\includegraphics[width=0.15\textwidth]{lrilogo.jpg}\\[-0.5em]
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{enumerate}
  \item instantiating the functor
  \begin{alltt}
    module W = struct
      type t = int
      let zero = 0
  ...
  \item using the resulting module
  \begin{alltt}
...
\begin{frame}
  ...
  \begin{center}
    \bleu{How to provide 19 implementations \\ 
